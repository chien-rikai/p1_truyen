            ...
            <li>
              <div class="dropdown-messages-box"><a href="profile.html" class="pull-left">
                ...
                <div class="message-body"><small class="pull-right">3 {{trans('messages.mins')}}</small>
                  <a href="#"><strong>John Doe</strong> {{trans('messages.commented')}} <strong>your photo</strong>.</a>
            ...
            <li>
              <div class="dropdown-messages-box"><a href="profile.html" class="pull-left">
                ...
                <div class="message-body"><small class="pull-right">1 {{trans('messages.hour')}}</small>
                  <a href="#">{{trans('messages.messenger')}} {{trans('messages.from')}} <strong>Jane Doe</strong>.</a>
